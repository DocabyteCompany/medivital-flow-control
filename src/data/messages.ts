...
export const messages: Record<string, Message[]> = {
  '1': [
    ...
    { id: 2, text: 'Puede revisar el resumen aquí: [Ir al resumen de Jorge Villareal](/ia-activities?title=Resumen%20m%C3%A9dico%20para%20Jorge%20Villareal&type=summary)', sender: 'me', timestamp: '11:10 AM' },
    { id: 3, text: 'Perfecto, gracias. Lo reviso de inmediato y me pongo en contacto con el equipo.', sender: '1', timestamp: '11:12 AM', avatar: `https://i.pravatar.cc/150?u=elian` },
  ],
  '2': [
    ...
    { id: 2, text: '¡Claro, Dra. García! He generado el resumen. Puede acceder a él desde aquí: [Ir a resumen para Sofía Ramirez](/ia-activities?title=Resumen%20de%20consulta%20para%20Sof%C3%ADa%20Ramirez&type=summary)', sender: 'me', timestamp: 'Ayer' },
    { id: 3, text: 'Muchas gracias.', sender: '2', timestamp: 'Ayer', avatar: `https://i.pravatar.cc/150?u=maria` },
  ],
  '3': [
  ...
  '4': [
    ...
    { id: 2, text: 'Por supuesto, Dra. López. He iniciado la llamada y le notificaré el resultado. Puede ver los detalles de la actividad aquí: [Ir a llamada con Laura Martínez](/ia-activities?title=Llamada%20con%20paciente%20Laura%20Mart%C3%ADnez&type=call)', sender: 'me', timestamp: 'Hace 2 días' },
    { id: 3, text: 'Excelente, quedo al pendiente.', sender: '4', timestamp: 'Hace 2 días', avatar: `https://i.pravatar.cc/150?u=ana` },
  ],
};
