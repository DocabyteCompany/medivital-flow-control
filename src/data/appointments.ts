...
export const appointments: Appointment[] = [
  ...
  { id: 'app4', patientId: '2', personnelId: '2', date: '2025-07-01', time: '09:00', type: 'Vacunación', status: 'Rescheduled' },
  ...
  // Laura Martínez (id: 4)
  { id: 'app7', patientId: '4', personnelId: '6', date: '2025-06-10', time: '11:00', type: 'Seguimiento Dermatológico', status: 'Cancelled' },
  ...
  { id: 'app10', patientId: '5', personnelId: '1', date: '2025-06-18', time: '09:00', type: 'Seguimiento Post-crítico', status: 'Rescheduled' },

  // Sofia Rodriguez (id: 6)
  { id: 'app11', patientId: '6', personnelId: '1', date: '2025-06-13', time: '15:00', type: 'Consulta General', status: 'Completed' },

  // Jorge Ramos (id: 7)
  { id: 'app12', patientId: '7', personnelId: '3', date: '2025-06-01', time: '12:00', type: 'Seguimiento Neurológico', status: 'Cancelled' },
